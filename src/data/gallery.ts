...
const GALLERY_PHOTO_SLUGS = {
	events: [
		...
		'dinosaur-birthday-party-table',
			'floral-fifth-birthday-balloon-backdrop',
			'baby-shark-character-hugging-kids',
			'pink-birthday-party-favor-jars',
			'easter-bunny-character-playroom-visit',
			'little-mermaid-character-kids-party',
			'pastel-peppa-pig-birthday-party-room',
	],
	buffet: [
		'assorted-savory-party-catering-platter',
		'fresh-catering-buffet-spread',
		'party-catering-table-salads-sandwiches',
		'caprese-skewers-party-catering-table',
		'mini-burgers-grilled-sandwich-party-platter',
		'pizza-sandwich-party-buffet',
		'smoked-salmon-crostini-hummus-pita-platter',
		...
		'croque-monsieur-party-bites-platter',
		'birthday-toasted-sandwiches-party-platter',
		'smoked-salmon-canapes-hello-kitty-party',
		'pizza-sliders-fries-party-buffet',
		'smoked-salmon-crostini-party-platter-closeup',
	],
	food: [
		'kids-turkey-sandwich-fries-cafe',
		'tomato-bruschetta-mixed-greens-cafe',
		'steak-avocado-feta-salad',
		'smoked-salmon-avocado-salad',
		'smoked-salmon-radish-avocado-salad',
		'cafe-sandwich-beside-indoor-playground',
			'smoked-salmon-toast-caesar-salad',
			'family-cafe-meal-burger-fries-pasta',
			'cheeseburger-fries-beside-playground',
			'croque-monsieur-fries-cafe-plate',
			'creamy-tomato-pasta-with-fries',
			'creamy-pasta-bowl-in-cafe',
	],
	'the-space': [
	...
	moments: [
		...
		'families-celebrating-full-venue-party',
		'children-watching-giant-bubble-show',
		'little-mermaid-princess-face-painting-event',
		'toddlers-wooden-playhouse-window',
			'toddler-pretend-play-ice-cream-cart',
			'families-gathered-outside-my-little-paris',
	],
} as const
